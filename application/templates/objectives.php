...
<script type="text/javascript" >
	$(function(){
		...
		<div id="essay_upload" class="upload">Upload Essay</div><span id="essay_status" class="status"></span>
		...
		<div id="resume_upload" class="upload">Upload R&eacute;sum&eacute;</div><span id="resume_status" class="status"></span>
	...
	<div id="pager">
		<p><span style="float:left;"><a href="app_manager.php?form_id=4"> << Previous Section</a></span>
		<span style="float:right;"><a href="app_manager.php?form_id=6"> Next Section >> </a></span></p>
	</div>
