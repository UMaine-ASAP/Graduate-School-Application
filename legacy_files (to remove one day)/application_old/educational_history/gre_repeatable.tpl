<div id="{{TABLE_NAME}}_{{INDEX}}" class="{{HIDE}}">
	<fieldset class="nested" >
		...
		<label for="gre_analytical[{{INDEX}}]">
			<p class="title">Analytical Writing</p>
			<input type="text" size="3" maxlength="3" id="gre_analytical[{{INDEX}}]" name="gre_analytical" value="{{GRE_ANALYTICAL}}" class="gre_analaytical" onblur="saveValue(event,{{USER}},'{{TABLE_NAME}}',{{INDEX}});" />
		</label>
