<div id="{{TABLE_NAME}}_{{INDEX}}" class="{{HIDE}}">
	<fieldset class="nested" >
		<legend>Additional Recommendation {{COUNT_INDEX}}</legend>
		<div>
			<label for="reference_online[{{INDEX}}]">
				<p class="required title">Will this individual submit a recommendation online? *</p>
				<label for="reference_online_yes[{{INDEX}}]"><input type="radio" id="reference_online_yes[{{INDEX}}]" name="reference_online[{{INDEX}}]" value="1" onchange="saveCheckValue(event,{{USER}},'{{TABLE_NAME}}',{{INDEX}});" /> Yes</label>
				<label for="reference_online_no[{{INDEX}}]"><input type="radio" id="reference_online_no[{{INDEX}}]" name="reference_online[{{INDEX}}]" value="0" onchange="saveCheckValue(event,{{USER}},'{{TABLE_NAME}}',{{INDEX}});" checked /> No</label>
			</label>
			...
			<div class="removeButton"><img src="images/minus.png" alt="Remove" title="Remove" onClick='removeItem("{{TABLE_NAME}}_{{INDEX}}",{{USER}});' /></div>
