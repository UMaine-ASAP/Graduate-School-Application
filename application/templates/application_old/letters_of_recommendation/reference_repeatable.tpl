	...
	<fieldset class="nested" >
		...
		<fieldset id="reference_addr[{{INDEX}}]" name="reference_addr" class="nested">
			...
			<label for="reference_postal[{{INDEX}}]">
				...
				<input type="text" size="15" maxlength="15" id="reference_postal[{{INDEX}}]" name="reference_postal" value="{{REFERENCE_POSTAL}}" onblur="saveValue(event,{{USER}},'{{TABLE_NAME}}',{{INDEX}});"/>
			</label>
