...
<fieldset id="grade_information" class="nested">
	...
	<label for="preenroll_courses">
		<p class="title">List, by title, all courses in programs or courses you expect to take before enrolling at UM. <b>Please have a supplementary transcript sent to the Graduate School when grades are available.</b></p>
