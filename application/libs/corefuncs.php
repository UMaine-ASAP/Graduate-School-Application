...
<head>
		...
		html {
			background:url(" . $GLOBALS['graduate_homepage'] . "sites/all/themes/acquia_marina/images/background-tile2.png) #143C55;
		}
...
function sendRecoverMessage($email, $code) {
	...
	<body>
	<a href=\"".$GLOBALS['graduate_homepage']."\"><img alt=\"The University of Maine 					Graduate School\" height=\"99\" width=\"245\" 		src='http://".$GLOBALS['$grad_app_root'] ."images/grad_logo.png' /></a>
