	...
	<body>
		<div id="mainbody">
			...
			<div id="form_pane" style="min-height:500px; margin:0px auto; max-width:650px;">
				<h1 style="text-align:center;">You have successfully submitted an online application to The University of Maine Graduate
				School, however your application fee payment transaction has been cancelled. Please contact the
				Graduate School office at 207-581-3291 to pay the application fee. Applications are not processed
				until an application fee has been received. Click here to return to the Graduate School homepage
				If you wish to apply again, please contact the University of Maine Graduate School at (207) 581-
				3291 or email graduate@maine.edu<br/>
				<br/>
