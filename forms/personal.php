...
<fieldset id="contact_info" name="contact_info">
		...
		<fieldset id="permanent_addr" name="permanent_addr" class="nested">
			<legend>Permanent Address</legend>
					...
					<label for="permanent_state">
						...
						<script type="text/javascript">getStateOptions('permanent_state');</script>
						<script type="text/javascript">initValue('permanent_state',"{{PERMANENT_STATE}}")</script>
					</label>
					...
					<label for="permanent_country">
						...
						<script type="text/javascript">getCountryOptions('permanent_country');</script>
						<script type="text/javascript">initValue('permanent_country',"{{PERMANENT_COUNTRY}}")</script>
					</label>
		...
		<fieldset id="mailing_addr" name="mailing_addr" class="nested">
			...
			<div id="mailing_perm_section">
				...
				<label for="mailing_state">
					...
					<!-- <script type="text/javascript">initValue('mailing_state',"{{MAILING_STATE}}");</script> -->
				</label>
				...
				<label for="mailing_country">
					...
					<script type="text/javascript">getCountryOptions('mailing_country');</script>
					<script type="text/javascript">initValue('mailing_country',"{{MAILING_COUNTRY}}")</script>
				</label>
			</div>
	...
	<fieldset class="nested">
		...
		<fieldset class="nested">
			...
			<label for="us_state">
				<p class="title">Legal resident of</p>
