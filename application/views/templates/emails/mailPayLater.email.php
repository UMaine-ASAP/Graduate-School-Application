...
$message .="\r\rYour application will be held for 60 days from the date your application was submitted, and then permanently removed from our files if no fee has been received.";
