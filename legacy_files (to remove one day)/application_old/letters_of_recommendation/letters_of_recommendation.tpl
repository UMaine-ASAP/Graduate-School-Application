...
<fieldset id="letters_of_recommendation" name="letters_of_recommendation">
	...
	<fieldset id="reference1" name="reference1" class="nested">
		...
		<div>
			...
			<label for="reference1_first">
				...
				<input type="text" size="30" maxlength="30" id="reference1_first" name="reference1_first" value="{{REFERENCE1_FIRST}}" class="reference1_first" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference1_last">
				<p class="required title">Last Name *</p>
				<input type="text" size="30" maxlength="30" id="reference1_last" name="reference1_last" value="{{REFERENCE1_LAST}}" class="reference1_last" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference1_email">
				<p class="title">E-Mail</p>
				<input type="text" size="30" id="reference1_email" name="reference1_email" value="{{REFERENCE1_EMAIL}}" class="reference1_email" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference1_relationship">
				<p class="title">Relationship</p>
				<select id="reference1_relationship" name="reference1_relationship" class="reference1_relationship" onchange="saveValue(event);">
			...
			<label for="reference1_phone">
				...
				<input type="text" size="16" maxlength="16" id="reference1_phone" name="reference1_phone" value="{{REFERENCE1_PHONE}}" class="reference1_phone" onblur="saveValue(event);"/>
			</label>
		...
		<fieldset id="reference1_addr" name="reference1_addr" class="nested">
			...
			<label for="reference1_addr1">
				...
				<input type="text" size="30" maxlength="30" id="reference1_addr1" name="reference1_addr1" value="{{REFERENCE1_ADDR1}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference1_addr2">
				<p class="title">Additional</p>
				<input type="text" size="30" maxlength="30" id="reference1_addr2" name="reference1_addr2" value="{{REFERENCE1_ADDR2}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference1_city">
				<p class="title">City</p>
				<input type="text" size="30" maxlength="30" id="reference1_city" name="reference1_city" value="{{REFERENCE1_CITY}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference1_state">
				<p class="title">State/Province</p>
				<select id="reference1_state"" name="reference1_state" size="1" onchange="saveValue(event);"></select>
			...
			<label for="reference1_postal">
				...
				<input type="text" size="15" maxlength="15" id="reference1_postal" name="reference1_postal" value="{{REFERENCE1_POSTAL}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference1_country">
				<p class="title">Country</p>
				<select id="reference1_country"" name="reference1_country" size="1" onchange="saveValue(event);"></select>
	...
	<fieldset id="reference2" name="reference2" class="nested">
		...
		<div>
			<label for="reference2_online">
				<p class="required title">Will this individual submit a recommendation online? *</p>
				<label for="reference2_online_yes"><input type="radio" class='online-check reference_online' id="reference2_online_yes" name="reference2_online" value="1" onchange="saveCheckValue(event);" /> Yes</label>
				<label for="reference2_online_no"><input type="radio" class='online-check reference_online' id="reference2_online_no" name="reference2_online" value="0" onchange="saveCheckValue(event);"  /> No</label>
			...
			<label for="reference2_first">
				<p class="required title">First Name *</p>
				<input type="text" size="30" maxlength="30" id="reference2_first" name="reference2_first" value="{{REFERENCE2_FIRST}}" class="reference2_first" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference2_last">
				<p class="required title">Last Name *</p>
				<input type="text" size="30" maxlength="30" id="reference2_last" name="reference2_last" value="{{REFERENCE2_LAST}}" class="reference2_last" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference2_email">
				<p class="title">E-Mail</p>
				<input type="text" size="30" id="reference2_email" name="reference2_email"value="{{REFERENCE2_EMAIL}}" class="reference2_email" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference2_relationship">
				<p class="title">Relationship</p>
				<select id="reference2_relationship" name="reference2_relationship" class="reference2_email" onchange="saveValue(event);">
					<option value=""	>- None -</option>
					<option value="Work" 	>Work</option>
					<option value="School" 	>School</option>
					<option value="Family" 	>Family</option>
			...
			<label for="reference2_phone">
				<p class="title">Phone Number</p>
				<input type="text" size="16" maxlength="16" id="reference2_phone" name="reference2_phone" value="{{REFERENCE2_PHONE}}" class="reference2_phone" onblur="saveValue(event);"/>
			</label>
		...
		<legend>Address</legend>
			<label for="reference2_addr1">
				<p class="title">Street</p>
				<input type="text" size="30" maxlength="30" id="reference2_addr1" name="reference2_addr1" value="{{REFERENCE2_ADDR1}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference2_addr2">
				<p class="title">Additional</p>
				<input type="text" size="30" maxlength="30" id="reference2_addr2" name="reference2_addr2" value="{{REFERENCE2_ADDR2}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference2_city">
				<p class="title">City</p>
				<input type="text" size="30" maxlength="30" id="reference2_city" name="reference2_city" value="{{REFERENCE2_CITY}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference2_state">
				<p class="title">State/Province</p>
				<select id="reference2_state"" name="reference2_state" size="1" onchange="saveValue(event);"></select>
			...
			<label for="reference2_postal">
				<p class="title">Postal Code</p>
				<input type="text" size="15" maxlength="15" id="reference2_postal" name="reference2_postal" value="{{REFERENCE2_POSTAL}}" onblur="saveValue(event);"/>
			</label>
							
			<label for="reference2_country">
				<p class="title">Country</p>
				<select id="reference2_country"" name="reference2_country" size="1" onchange="saveValue(event);"></select>
	...
	<fieldset id="reference3" name="reference3" class="nested">
		...
		<div>
			<label for="reference3_online" >
				<p class="required title">Will this individual submit a recommendation online? *</p>
				<label for="reference3_online_yes"><input type="radio" class='online-check reference_online' id="reference3_online_yes" name="reference3_online" value="1" onchange="saveCheckValue(event);" /> Yes</label>
				<label for="reference3_online_no"><input type="radio" class='online-check reference_online' id="reference3_online_no" name="reference3_online" value="0" onchange="saveCheckValue(event);" checked /> No</label>
			</label>
			...
			<label for="reference3_first">
				<p class="required title">First Name *</p>
				<input type="text" size="30" maxlength="30" id="reference3_first" name="reference3_first" value="{{REFERENCE3_FIRST}}" class="reference3_first" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference3_last">
				<p class="required title">Last Name *</p>
				<input type="text" size="30" maxlength="30" id="reference3_last" name="reference3_last" value="{{REFERENCE3_LAST}}" class="reference3_last" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference3_email">
				<p class="title">E-Mail</p>
				<input type="text" size="30" id="reference3_email" name="reference3_email" value="{{REFERENCE3_EMAIL}}" class="reference3_email" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference3_relationship">
				<p class="title">Relationship</p>
				<select id="reference3_relationship" name="reference3_relationship" class="reference3_relationship" onchange="saveValue(event);">
					<option value=""	>- None -</option>
					<option value="Work" 	>Work</option>
					<option value="School" 	>School</option>
					<option value="Family" 	>Family</option>
			...
			<label for="reference3_phone">
				<p class="title">Phone Number</p>
				<input type="text" size="16" maxlength="16" id="reference3_phone" name="reference3_phone" value="{{REFERENCE3_PHONE}}" class="reference3_phone" onblur="saveValue(event);"/>
			</label>
		...
		<legend>Address</legend>
			<label for="reference3_addr1">
				<p class="title">Street</p>
				<input type="text" size="30" maxlength="30" id="reference3_addr1" name="reference3_addr1" value="{{REFERENCE3_ADDR1}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference3_addr2">
				<p class="title">Additional</p>
				<input type="text" size="30" maxlength="30" id="reference3_addr2" name="reference3_addr2" value="{{REFERENCE3_ADDR2}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference3_city">
				<p class="title">City</p>
				<input type="text" size="30" maxlength="30" id="reference3_city" name="reference3_city" value="{{REFERENCE3_CITY}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference3_state">
				<p class="title">State/Province</p>
				<select id="reference3_state"" name="reference3_state" size="1" onchange="saveValue(event);"></select>
			...
			<label for="reference3_postal">
				<p class="title">Postal Code</p>
				<input type="text" size="15" maxlength="15" id="reference3_postal" name="reference3_postal" value="{{REFERENCE3_POSTAL}}" onblur="saveValue(event);"/>
			</label>
			
			<label for="reference3_country">
				<p class="title">Country</p>
				<select id="reference3_country"" name="reference3_country" size="1" onchange="saveValue(event);"></select>
	...
	<fieldset id="extrareferences" name="extrareferences" class="nested">
		...
		<button class="button green small add" type="button" onClick="addItem('{{EXTRAREFERENCES_TABLE_NAME}}'); return false;" title="Add">+ Add Another Reference</button>
	...
	<div id="pager">
		<p><span style="float:left;"><a href="app_manager.php?form_id=5"><span class="chevron">&#0171;</span> Previous Section</a></span>
		<span style="float:right;"><a href="submission_manager.php">Review Application <span class="chevron">&#0187;</span></a></span></p>
	</div>
