...
function sendSuccessMessage($email, $code) {
	...
	$confirm_url = "http". ((!empty($_SERVER['HTTPS'])) ? "s" : ""). "://".$GLOBALS['server_name'].$_SERVER['REQUEST_URI'];
...
<head>
	...
	<div id=\"message\">
		...
		<p>An account for the University of Maine Graduate School Online Application has been requested for the e-mail address $email, Please confirm this address is correct before filling out the application.\r\rClick here to confirm: <a href=\"$confirm_url?email=$recipient_email&code=$code\">$confirm_url?email=$recipient_email&code=$code</a></p>
