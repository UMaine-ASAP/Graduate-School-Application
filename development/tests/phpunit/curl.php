 ...
 * 
 * src: http://omni-spot.blogspot.com/2010/09/unit-testing-curl-code-in-php.html
 */
class Curl {
    /**
    ...
    {
        $fh = fopen("myCookiefile.txt", "rb");
        $data = fread($fh, filesize("myCookiefile.txt"));
        fclose($fh);

        $cookieValue = 'nnl06tmacd6r1t3l7e3t2d0920';
        $strCookie = 'PHPSESSID=' . $cookieValue . '; path=/';
