...
if(arg(3) == 1) {
	...
	$vars['form']['group_place_of_birth']['field_place_of_birth']['0']['city']['#title'] = 'City of Birth';
	$vars['city_of_birth'] = drupal_render($vars['form']['group_place_of_birth']['field_place_of_birth']['0']['city']);
	$vars['form']['group_place_of_birth']['field_place_of_birth']['0']['province']['#title'] = 'State or Province of Birth';
	$vars['state_of_birth'] = drupal_render($vars['form']['group_place_of_birth']['field_place_of_birth']['0']['province']);
	$vars['form']['group_place_of_birth']['field_place_of_birth']['0']['country']['#title'] = 'Country of Birth';
	$vars['country_of_birth'] = drupal_render($vars['form']['group_place_of_birth']['field_place_of_birth']['0']['country']);
	$vars['form']['group_place_of_birth']['field_coc']['0']['country']['#title'] = 'Country of Citizenship';
	$vars['country_of_citizenship'] = drupal_render($vars['form']['group_place_of_birth']['field_coc']['0']['country']);
	$vars['residency_status'] = drupal_render($vars['form']['group_place_of_birth']['field_residency']);
	$vars['ethnic_background'] = drupal_render($vars['form']['group_place_of_birth']['field_ethnic']);
   
    //permanent address group
	$vars['form']['group_perm_address']['field_permanent_address']['0']['street']['#title'] = 'Street Address';
	$vars['perm_street_1'] = drupal_render($vars['form']['group_perm_address']['field_permanent_address']['0']['street']);
	$vars['form']['group_personal_information']['group_perm_address']['0']['additional']['#title'] = '';
	$vars['perm_street_2'] = drupal_render($vars['form']['group_perm_address']['field_permanent_address']['0']['additional']);
	$vars['perm_city'] = drupal_render($vars['form']['group_perm_address']['field_permanent_address']['0']['city']);
	$vars['perm_state'] = drupal_render($vars['form']['group_perm_address']['field_permanent_address']['0']['province']);
	$vars['perm_zip'] = drupal_render($vars['form']['group_perm_address']['field_permanent_address']['0']['postal_code']);
	$vars['perm_country'] = drupal_render($vars['form']['group_perm_address']['field_permanent_address']['0']['country']);
   
    //mailing address group
	$vars['form']['group_mail_address']['field_mailing_address']['0']['street']['#title'] = 'Street Address';
	$vars['mail_street_1'] = drupal_render($vars['form']['group_mail_address']['field_mailing_address']['0']['street']);
	$vars['form']['group_mail_address']['field_mailing_address']['0']['additional']['#title'] = '';
	$vars['mail_street_2'] = drupal_render($vars['form']['group_mail_address']['field_mailing_address']['0']['additional']);
	$vars['mail_city'] = drupal_render($vars['form']['group_mail_address']['field_mailing_address']['0']['city']);
	$vars['mail_state'] = drupal_render($vars['form']['group_mail_address']['field_mailing_address']['0']['province']);
	$vars['mail_zip'] = drupal_render($vars['form']['group_mail_address']['field_mailing_address']['0']['postal_code']);
	$vars['mail_country'] = drupal_render($vars['form']['group_mail_address']['field_mailing_address']['0']['country']);
...
if(arg(3) == 2) {
	...
	//$vars['int'] = $vars['form']['buttons']['next']['#submit'];
